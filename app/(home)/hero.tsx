...
const tabs = [

  {
    ...
    description: "Share the knowledge and social engineering.",
    more: (
...

  {
    ...
    description: "Present your ideas and research to showcase your wide expertise.",
    more: (
  ...
  },
  {
    ...
    name: "Exhibitors",
    description: "We invite industries to participate and exhibit their products",
    more: (
...
const Hero = () => {
  ...
  text-5xl
            ...
            "
        >
          Write, plan, share. With IEEE at your side.
        </div>
        ...
        <div className="pt-10 pb-10 xl:pt-20 flex items-center justify-center">
  <Image
    src="/images/hero.jpg"
    alt="hero image"
    width={1000}
